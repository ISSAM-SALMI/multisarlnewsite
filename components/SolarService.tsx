    ...
    <div className="min-h-screen bg-slate-50 dark:bg-navy-900 pt-20 pb-10 md:pt-24 md:pb-12">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16 md:mb-20">
          <h2 className="text-2xl md:text-3xl font-bold text-center text-navy-900 dark:text-white mb-8 md:mb-12">Expertise Photovoltaïque</h2>
        ...
        <div className="bg-navy-900 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">Passez à l'énergie solaire</h2>
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Réduisez votre facture et gagnez en autonomie avec nos solutions photovoltaïques clé en main.
            </p>
            <Link 
              to="/#contact" 
              className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-6 md:py-4 md:px-8 rounded-full transition-all transform hover:-translate-y-1 shadow-lg shadow-orange-900/50 text-sm md:text-base"
            >

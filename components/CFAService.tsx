  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-navy-900 pt-24 pb-12">
      <div className="container mx-auto px-4">
        ...
        {/* Features Grid */}
        <div className="mb-20">
          <h2 className="text-3xl font-bold text-center text-navy-900 dark:text-white mb-12">Nos Domaines d'Expertise</h2>
        ...
        <div className="bg-navy-900 rounded-3xl p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-3xl font-bold text-white mb-6">Un projet de réseau ou sécurité ?</h2>
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Nos experts CFA vous accompagnent de la conception à la maintenance de vos installations.
            </p>
            <Link 
              to="/#contact" 
              className="inline-flex items-center gap-2 bg-electric-blue hover:bg-blue-600 text-white font-bold py-4 px-8 rounded-full transition-all transform hover:-translate-y-1 shadow-lg shadow-blue-900/50"
            >

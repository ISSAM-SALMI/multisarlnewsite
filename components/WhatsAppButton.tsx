...
export const WhatsAppButton: React.FC = () => {
  return (
    ...
    >
      ...
      {/* Main Button */}
      <div className="relative bg-[#25D366] hover:bg-[#128C7E] text-white p-4 rounded-full shadow-2xl transition-all transform hover:scale-110 flex items-center justify-center">
        {/* WhatsApp SVG Logo */}
        <svg 
          viewBox="0 0 24 24" 
          width="32" 

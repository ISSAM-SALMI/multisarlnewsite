...
export const CFOService: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-navy-950 transition-colors duration-300">
      {/* Hero Section */}
      <div className="relative bg-navy-900 pt-20 pb-10 md:pt-32 md:pb-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start mb-16 md:mb-20">
          <div className="text-center md:text-left">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-3 p-4 bg-slate-50 dark:bg-navy-900 rounded-lg border-l-4 border-electric-red">
                <CheckCircle2 className="w-6 h-6 text-electric-red flex-shrink-0" />
                <span className="font-medium text-navy-900 dark:text-white text-center md:text-left">Conformité stricte aux normes de sécurité</span>
              </div>
              <div className="flex flex-col md:flex-row items-center md:items-start gap-3 p-4 bg-slate-50 dark:bg-navy-900 rounded-lg border-l-4 border-blue-500">
                <CheckCircle2 className="w-6 h-6 text-blue-500 flex-shrink-0" />
                <span className="font-medium text-navy-900 dark:text-white text-center md:text-left">Solutions adaptées à chaque secteur d'activité</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative h-[250px] md:h-[500px] rounded-2xl overflow-hidden shadow-2xl group">
            ...
            <div className="absolute bottom-0 left-0 p-6 md:p-8 text-center md:text-left w-full">
        ...
        <div className="mb-16 md:mb-20">
          <h2 className="text-2xl md:text-3xl font-bold text-center text-navy-900 dark:text-white mb-8 md:mb-12">Nos Domaines d'Intervention</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-white dark:bg-navy-800 p-6 md:p-8 rounded-xl shadow-lg border border-slate-100 dark:border-navy-700 hover:shadow-xl transition-all hover:-translate-y-1 group text-center md:text-left">
                <div className="w-14 h-14 bg-slate-50 dark:bg-navy-900 rounded-lg flex items-center justify-center mb-6 mx-auto md:mx-0 group-hover:scale-110 transition-transform duration-300">
                  {feature.icon}
                </div>
        ...
        <div className="bg-navy-900 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">Besoin d'une installation électrique fiable ?</h2>
            ...
            <Link 
              to="/#contact" 
              className="inline-flex items-center gap-2 bg-electric-red hover:bg-red-600 text-white font-bold py-3 px-6 md:py-4 md:px-8 rounded-full transition-all transform hover:-translate-y-1 shadow-lg shadow-red-900/50 text-sm md:text-base"
            >

    ...
    <div className="min-h-screen bg-slate-50 dark:bg-navy-900 pt-20 pb-10 md:pt-24 md:pb-12">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16 md:mb-20">
          <h2 className="text-2xl md:text-3xl font-bold text-center text-navy-900 dark:text-white mb-8 md:mb-12">Expertise Technique</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-white dark:bg-navy-800 p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100 dark:border-navy-700 group hover:-translate-y-1 text-center md:text-left">
                <div className="w-12 h-12 bg-orange-50 dark:bg-navy-700 rounded-lg flex items-center justify-center mb-6 mx-auto md:mx-0 group-hover:scale-110 transition-transform">
                  {feature.icon}
                </div>
        ...
        <div className="bg-navy-900 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">Besoin d'un poste de transformation ?</h2>
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Nos experts MT/BT vous accompagnent pour une installation sécurisée et conforme.
            </p>
            <Link 
              to="/#contact" 
              className="inline-flex items-center gap-2 bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 px-6 md:py-4 md:px-8 rounded-full transition-all transform hover:-translate-y-1 shadow-lg shadow-orange-900/50 text-sm md:text-base"
            >
